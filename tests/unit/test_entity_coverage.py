...
entity_samples = [
    ...
    # EMAIL_ADDRESS
    ("EMAIL_ADDRESS", "My email is john@example.com", "<EMAIL_ADDRESS>"),
    ("EMAIL_ADDRESS", "Email: hans@test.de", "<EMAIL_ADDRESS>"),
    ("EMAIL_ADDRESS", "Correo: marie@gmail.com", "<EMAIL_ADDRESS>"),
    ("EMAIL_ADDRESS", "بريدي ahmed@example.com", "<EMAIL_ADDRESS>"),

    # PHONE_NUMBER
    ("PHONE_NUMBER", "+1 (555) 123-4567", "<PHONE_NUMBER>"),
    ("PHONE_NUMBER", "+49 151 23456789", "<PHONE_NUMBER>"),
    ("PHONE_NUMBER", "+966 50 123 4567", "<PHONE_NUMBER>"),
    ...
    ("EMAIL_ADDRESS", "You can contact me at jane.smith@gmail.com", "<EMAIL_ADDRESS>"),
    ("PHONE_NUMBER", "Call me at +1 555-123-4567", "<PHONE_NUMBER>"),
    ...
    ("API_KEY", "My API key is sk_live_abc123def456", "<API_KEY>"),
    ...
    ("FAX_NUMBER", "My fax number is +1 555-123-4568", "<FAX_NUMBER>"),
    ...
    ("EMAIL_ADDRESS", "Sie können mich unter max.mueller@example.de erreichen", "<EMAIL_ADDRESS>"),
    ("PHONE_NUMBER", "Rufen Sie mich unter +49 123 456789 an", "<PHONE_NUMBER>"),
    ...
    ("API_KEY", "Mein API-Schlüssel ist sk_live_abc123def456", "<API_KEY>"),
    ...
    ("FAX_NUMBER", "Meine Faxnummer ist +49 30 1234567", "<FAX_NUMBER>"),
