...
**Anonymized:** `ich habe meinen <PASSPORT> als Elektriker <ADDRESS>.`  
...
**Source:** some examples 4:  
**Original:** `Ich bin beschäftigt schon.`  
**Anonymized:** `Ich bin beschäftigt schon.`  
...
**Anonymized:** `<PASSPORT> <PRO_LICENSE>: ARC-<PHONE_NUMBER>`  
