...
**Anonymized:** `Code Postal: <ACCESS_CODE>`  
...
**Source:** German - Basics  
**Original:** `ich bin Sebastian Holz und ich wohne in blablastrasse. 9, wer bist du? Ich will ein Gewerbe anmelden`  
**Anonymized:** `ich bin <PERSON> und ich wohne <ADDRESS>, wer bist du? Ich will ein Gewerbe anmelden`  

**Source:** German - Basics  
**Original:** `Ich Bin Anna Müller und ich wohne in der Blablastrasse 9, Berlin 10999. Ich will ein Gewerbe anmelden`  
**Anonymized:** `Ich Bin <PERSON> und ich wohne <ADDRESS> 10999. Ich will ein Gewerbe anmelden`  
...
**Source:** some examples 5:  
**Original:** `Ich wohne in der Musterstraße 5, 10115 Berlin (Mitte).`  
**Anonymized:** `Ich wohne <ADDRESS> (<LOCATION>).`  

**Source:** some examples 5:  
**Original:** `Die Adresse wäre Karl-Marx-Straße 201, 12055 Berlin.`  
**Anonymized:** `Die Adresse wäre <ADDRESS>.`  

**Source:** some examples 5:  
**Original:** `ich betreibe ein Gewerbe unter der Nummer GEW-2025-7788.`  
**Anonymized:** `ich betreibe ein Gewerbe <ADDRESS>.`  

**Source:** some examples 5:  
**Original:** `ich habe meinen Abschluss als Elektriker in Polen gemacht und bin am 21.08.1995 geboren.`  
**Anonymized:** `ich habe meinen Abschluss als Elektriker <ADDRESS>.`  
...
**Anonymized:** `Numero di matricola: <ADDRESS>`  
...
**Anonymized:** `GitHub Token: <API_KEY>`  
...
**Source:** German - Basics  
**Original:** `ich heisse max mustermann und ich bin am 31.12.1990 geboren.`  
**Anonymized:** `ich heisse max mustermann und ich bin am <DATE> geboren.`  
...
**Anonymized:** `بريدي الإلكتروني <EMAIL_ADDRESS> ورقم هاتفي <PHONE_NUMBER>.`  
...
**Anonymized:** `Meine E-Mail ist <EMAIL_ADDRESS> und meine Nummer ist 0176 12345678.`  
...
**Anonymized:** `You can reach me at <EMAIL_ADDRESS> or call <PHONE_NUMBER>.`  
...
**Anonymized:** `Twitter <SOCIAL_HANDLE>, email <EMAIL_ADDRESS>, Discord <MESSAGING_ID>,`  
...
**Anonymized:** `Mi correo es <EMAIL_ADDRESS> y mi teléfono es <PHONE_NUMBER>.`  
...
**Anonymized:** `E‑posta adresim <EMAIL_ADDRESS> ve telefon numaram <PHONE_NUMBER>.`  
...
**Anonymized:** `Mitarbeiternummer: <EMPLOYEE_ID>`  
...
**Anonymized:** `Personalnummer: <EMPLOYEE_ID>`  
...
**Anonymized:** `NHS number <HEALTH_ID>, MRN: <MRN>, Insurance policy: <INSURANCE_ID>.`  
...
**Anonymized:** `<HEALTH_INFO>: Hypertension treatment`  

**Source:** Healthcare & Administrative IDs  
**Original:** `Condition: Diagnosed with cancer`  
**Anonymized:** `Condition: <HEALTH_INFO> with <HEALTH_INFO>`  
...
**Anonymized:** `Insurance ID <INSURANCE_ID>`  

**Source:** Healthcare & Administrative IDs  
**Original:** `Insurance member: MYINSUR1234567`  
**Anonymized:** `Insurance member: <INSURANCE_ID>`  
...
**Source:** some examples 5:  
**Original:** `Ich ziehe mit meinem Business um – wo melde ich die neue Adresse für mein Gewerbe an?`  
**Anonymized:** `Ich ziehe mit meinem Business um – wo melde ich die neue <LOCATION> für mein Gewerbe an?`  
...
**Anonymized:** `Militärausweis: <MILITARY_ID>`  
...
**Anonymized:** `Carte militaire: <MILITARY_ID>`  
...
**Anonymized:** `PHPSESSID: 9a1f6d3a8e4b7c2f5d9b1a3e6c8f2b5d`  
...
**Anonymized:** `Gibt es Beratungszentern in Tempelhof-Shöneberg für Gründung von Unternehmen?`  

**Source:** German - Basics  
**Original:** `"Ich bin beschäftigt."`  
**Anonymized:** `"Ich bin beschäftigt."`  

**Source:** German - Basics  
**Original:** `"Ich bin nicht beschäftigt."`  
**Anonymized:** `"Ich bin nicht beschäftigt."`  

**Source:** German - Basics  
**Original:** `"Ich bin heute beschäftigt."`  
**Anonymized:** `"Ich bin heute beschäftigt."`  

**Source:** German - Basics  
**Original:** `"Ich bin beschäftigt heute."`  
**Anonymized:** `"Ich bin beschäftigt heute."`  

**Source:** German - Basics  
**Original:** `"Ich bin sehr beschäftigt."`  
**Anonymized:** `"Ich bin sehr beschäftigt."`  

**Source:** German - Basics  
**Original:** `"Ich bin beschäftigt sehr"`  
**Anonymized:** `"Ich bin beschäftigt sehr"`  

**Source:** German - Basics  
**Original:** `"Ich bin beschäftigt einfach."`  
**Anonymized:** `"Ich bin beschäftigt einfach."`  

**Source:** German - Basics  
**Original:** `"Ich bin einfach beschäftigt."`  
**Anonymized:** `"Ich bin einfach beschäftigt."`  
...
**Source:** German - Basics  
**Original:** `"Ich bin mark beschäftigt."`  
**Anonymized:** `"Ich bin mark beschäftigt."`  

**Source:** German - Basics  
**Original:** `"Ich bin beschäftigt schmidt."`  
**Anonymized:** `"Ich bin beschäftigt schmidt."`  
...
**Anonymized:** `UDID: DEV-555666777`  

**Source:** some examples 2:  
**Original:** `ich will Gewerbe anmelden.`  
**Anonymized:** `ich will Gewerbe anmelden.`  

**Source:** some examples 3:  
**Original:** `Gibt es Beratungszentern in Tempelhof-Shöneberg für Gründung von Unternehmen?`  
**Anonymized:** `Gibt es Beratungszentern in Tempelhof-Shöneberg für Gründung von Unternehmen?`  

**Source:** some examples 3:  
**Original:** `Gibt es in Tempelhof-Shöneberg Beratungsstellen für Gastronomiebetriebe?`  
**Anonymized:** `Gibt es in Tempelhof-Shöneberg Beratungsstellen für Gastronomiebetriebe?`  

**Source:** some examples 3:  
**Original:** `Ich bin Elektriker und habe meine Ausbildung in Polen gemacht. Wie geht das mit Anerkennung?`  
**Anonymized:** `Ich bin Elektriker und habe meine Ausbildung in Polen gemacht. Wie geht das mit Anerkennung?`  
...
**Source:** some examples 4:  
**Original:** `Ich bin mark und bin beschäftigt.`  
...
**Source:** some examples 4:  
**Original:** `Ich bin mark schmidt.`  
**Anonymized:** `Ich bin mark schmidt.`  
...
**Anonymized:** `Residence Permit: RP-2024-123456`  
...
**Anonymized:** `Medications: Insulin, Metformin`  

**Source:** Healthcare & Administrative IDs  
**Original:** `Reference: REF2024555444`  
**Anonymized:** `Reference: REF2024555444`  
...
**Anonymized:** `Fascicolo: FASC2024456789`  
...
**Anonymized:** `Device identifier: DEV-444555666`  
...
**Source:** some examples 3:  
**Original:** `Hallo mein Name ist lukas fuchs. Meine Personalausweisnummer ist L01X00T47. Ich möchte einen neuen Personalausweis beanragen`  
**Anonymized:** `Hallo mein Name ist lukas fuchs. Meine Personalausweisnummer ist <PASSPORT>. Ich möchte einen neuen Personalausweis beanragen`  

**Source:** some examples 3:  
**Original:** `Hallo mein Name ist lukas fuchs. Meine Personalausweisnummer ist L01X00T47. Ich möchte einen neuen Personalausweis beantragen`  
**Anonymized:** `Hallo mein Name ist lukas fuchs. Meine Personalausweisnummer ist <PASSPORT>. Ich möchte einen neuen Personalausweis beantragen`  
...
**Anonymized:** `Passeport (UE): <PASSPORT>`  
...
**Anonymized:** `Tax ID: CH CHE <PASSPORT> TVA`  
...
**Anonymized:** `Guten Tag, mein name ist <PERSON>, ich möchte ein Gewerbe anmelden.`  
...
**Anonymized:** `Voter Registration: VOT-<PHONE_NUMBER>`  

**Source:** Government & Official IDs  
**Original:** `Permit Number: P-2024-999888`  
**Anonymized:** `Permit Number: P-<PHONE_NUMBER>`  

**Source:** Government & Official IDs  
**Original:** `Aufenthaltserlaubnis: AE-2024-555666`  
**Anonymized:** `Aufenthaltserlaubnis: AE-<PHONE_NUMBER>`  

**Source:** Government & Official IDs  
**Original:** `Staff Number: STF-2024-555666`  
**Anonymized:** `Staff Number: STF-<PHONE_NUMBER>`  

**Source:** Government & Official IDs  
**Original:** `Enrollment Number: ENR-2024-112233`  
**Anonymized:** `Enrollment Number: ENR-<PHONE_NUMBER>`  

**Source:** Government & Official IDs  
**Original:** `Child Benefit: CHB-2024-321456`  
**Anonymized:** `Child Benefit: CHB-<PHONE_NUMBER>`  

**Source:** Financial & Routing  
**Original:** `Document Number: DOC-2024-777888`  
**Anonymized:** `Document Number: DOC-<PHONE_NUMBER>`  

**Source:** Financial & Routing  
**Original:** `Order Number: ORD-2024-456789`  
**Anonymized:** `Order Number: ORD-<PHONE_NUMBER>`  
...
**Anonymized:** `Service Number: SN-<PHONE_NUMBER>`  

**Source:** Government & Official IDs  
**Original:** `Military Service Number: MSN-1990-234567`  
**Anonymized:** `Military Service Number: MSN-<PHONE_NUMBER>`  

**Source:** Government & Official IDs  
**Original:** `Architect License: ARC-2024-111222`  
**Anonymized:** `Architect <PRO_LICENSE>: ARC-<PHONE_NUMBER>`  

**Source:** Government & Official IDs  
**Original:** `Professional Registration: PRF-2024-333444`  
**Anonymized:** `Professional Registration: PRF-<PHONE_NUMBER>`  

**Source:** Financial & Routing  
**Original:** `Invoice Number: INV-2024-999000`  
**Anonymized:** `Invoice Number: INV-<PHONE_NUMBER>`  

**Source:** Healthcare & Administrative IDs  
**Original:** `Health record: 789 012 3456`  
**Anonymized:** `Health record: <PHONE_NUMBER>`  
...
**Anonymized:** `Electoral Card: <PHONE_NUMBER>`  
...
**Anonymized:** `Transit Number: <PHONE_NUMBER>`  
...
**Anonymized:** `Travel Document: TD-<PHONE_NUMBER>`  
...
**Anonymized:** `Aufenthaltstitel: <RESIDENCE_PERMIT>`  
...
**Anonymized:** `My residence permit is <RESIDENCE_PERMIT>`  
...
**Anonymized:** `Residence permit: <RESIDENCE_PERMIT>`  
...
**Anonymized:** `Numéro d'établissement: NE <TAX_ID>`  
